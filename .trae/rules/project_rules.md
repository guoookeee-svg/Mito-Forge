...
## Lint and Typecheck
- After making changes, run: `python -c "import mito_forge"` to verify imports
- Check specific modules: `python -c "from mito_forge.core.agents.annotation_agent import AnnotationAgent"`
